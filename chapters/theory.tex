\chapter{Theory}
%aj an over view what is included in the chapter
\section{Ranging sensors}

%aj above line is not necessary, so removed it
...
%aj reference is [29]. I do not understand why your referece are not in sequence ?
...
%aj you can use the equations form radar lecture to give the equation of distance. in all case, the equation of distance has to be included in the chapter
...
%aj some theory on navigation, including Kalman, sensor fusion, odometry ...
